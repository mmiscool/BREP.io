...
function normalizeTheme(theme: AnyRecord = {}) {
...
class EmbeddedSketchViewer {
  ...
  setGridOptions(options: AnyRecord = {}) {
...
class Sketcher2DFrameApp {
  ...
  #applyGridOptions(payload: AnyRecord = {}) {
...
export function bootSketcher2DFrame(config: AnyRecord = {}) {
  try {
