...
export class HistoryCollectionWidget {
  ...
  collapseExpandedEntries({ clearOpenState = true, notify = true }: any = {}) {
  ...
  revealEntry(id, { focus = true, scroll = true, notify = true }: any = {}) {
  ...
  _applyDisplayInfo(entry, index, entryId, elements: any = {}) {
  ...
  _defaultControlDescriptors(context: any = {}) {
  ...
  _createReorderHandleControl(context: any = {}) {
  ...
  _maybeRenderEntryToggle(context: any = {}) {
  ...
  _captureSelectionFilterSnapshot({ force = false }: any = {}) {
  ...
  _createHelperContext(context: any = {}) {
    const {
      entry = null,
      id = null,
      index = null,
  ...
  _normalizeEntryToggle(config: any) {
  ...
  _composeMenuItem(rawType, rawLabel, source: any = null, _extraNames: any[] = []) {
  ...
  _extractDisplayNames(source: any, fallbackType = '', fallbackLabel = '') {
  ...
  _filterSchemaForEntry(entry, schema, entryId: any = null) {
    ...
    const context: any = this._createHelperContext({
      entry,
      id: entryId,
      schema,
  ...
  _normalizeExcludeKeySet(result, fallbackKeys: any[] = []) {
    const set = new Set();
    let list = null;
  ...
  _recordUiFieldSignature(entryId, keys: any[] = []) {
  ...
  _uiFieldsSignatureFromKeys(keys: any[] = []) {
  ...
  _attachReorderDropHandlers(item, context: any = {}) {
  ...
  _handleReorderDragStart(event, context: any = {}) {
    const entryId = context?.id != null ? String(context.id) : null;
    if (!entryId) return;
    this._resetDragState();
    this._dragState = {
