...
export async function loadPNGToImageData(source: any) {
...
export function vectorizeImageData(imageData: ImageData, options: any = {}) {
...
export function shapesToSVG(shapes: any[], width: number, height: number, options: any = {}) {
  const svgOpts = {
    stroke: "#111",
    strokeWidth: 2.5,
    fill: "none",
...
export function renderShapesToSVG(svgEl: SVGSVGElement, shapes: any[], options: any = {}) {
...
function shapesMarkup(shapes: any[], options: any) {
...
function ensureImageLoaded(img: HTMLImageElement) {
