...
type FeatureDimensionContext = Record<string, any>;
type FeatureDimensionDescriptor = Record<string, any> & {
  featureKey?: unknown;
  supportsTransformDimensionToggle?: boolean;
  buildAnnotations?: (context: FeatureDimensionContext) => unknown;
};

const FEATURE_DIMENSION_DESCRIPTORS = new Map();

function registerFeatureDimensionDescriptor(descriptor: FeatureDimensionDescriptor = {}) {
...
export function buildFeatureDimensionAnnotations(context: FeatureDimensionContext = {}) {
