...
function remapSupplementaryAngle(value: any) {
...
export class AssemblyConstraintCollectionWidget extends HistoryCollectionWidget {
  ...
  constructor({
    ...
    const callBeforeChange = (payload: any = {}) => {
    ...
    const formOptionsProvider = (context: any = {}) => {
  ...
  setPartHistory(partHistory: any) {
    this.partHistory = partHistory || null;
  }

  focusEntryById(targetId: any, { behavior = 'smooth', focusField = null }: any = {}) {
    ...
    if (el && typeof el.scrollIntoView === 'function') {
      el.scrollIntoView({ behavior: behavior as any, block: 'center' });
    }
  }
  ...
  async _reorderEntryToIndex(id: any, targetIndex: any) {
    if (!id) return false;
  ...
  #notifyBeforeChange(payload: any = {}) {
  ...
  #handleFormReady({ entry, form }: any) {
