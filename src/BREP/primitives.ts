...
export class Pyramid extends PrimitiveBase {
  constructor(...args: any[]) {
    const { bL = 1, s = 4, h = 1, name = 'Pyramid' } = args[0] || {};
...
export class Sphere extends PrimitiveBase {
  constructor(...args: any[]) {
    const { r = 1, resolution = 24, name = 'Sphere' } = args[0] || {};
...
export class Torus extends PrimitiveBase {
  constructor(...args: any[]) {
    const { mR = 2, tR = 0.5, resolution = 48, arcDegrees = 360, name = 'Torus', centerlines = true } = args[0] || {};
...
export class Cube extends PrimitiveBase {
  constructor(...args: any[]) {
    const { x = 1, y = 1, z = 1, name = 'Cube' } = args[0] || {};
...
export class Cylinder extends PrimitiveBase {
  constructor(...args: any[]) {
    const { radius = 1, height = 1, resolution = 32, name = 'Cylinder', centerlines = true } = args[0] || {};
...
export class Cone extends PrimitiveBase {
  constructor(...args: any[]) {
    const { r1 = 0.5, r2 = 1, h = 1, resolution = 32, name = 'Cone', centerlines = true } = args[0] || {};
