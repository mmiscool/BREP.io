...
type SelectionResolverObject = {
  name?: string;
  type?: string;
  userData?: Record<string, unknown>;
  geometry?: unknown;
  isObject3D?: boolean;
  getObjectByName?: (name: string) => SelectionResolverObject | null | undefined;
  getObjectByProperty?: (property: string, value: string) => SelectionResolverObject | null | undefined;
  traverse?: (callback: (object: SelectionResolverObject) => void) => void;
  [key: string]: unknown;
};

type SelectionResolverOptions = {
  scoreFn?: ((object: SelectionResolverObject) => number) | null;
  nameResolver?: ((name: string) => SelectionResolverObject | null | undefined) | null;
  arrayMode?: 'first' | 'firstResolved' | string;
  allowJson?: boolean;
  allowUuid?: boolean;
  allowUuidString?: boolean;
  allowUuidObject?: boolean;
  allowFuzzyName?: boolean;
  allowNameContains?: boolean;
  allowPath?: boolean;
  allowReference?: boolean;
  allowTarget?: boolean;
  allowSelectionName?: boolean;
  allowObjectPassthrough?: boolean;
};

type ResolvedSelectionResolverOptions = Required<Omit<SelectionResolverOptions, 'allowUuid' | 'scoreFn' | 'nameResolver'>> & {
  scoreFn: ((object: SelectionResolverObject) => number) | null;
  nameResolver: ((name: string) => SelectionResolverObject | null | undefined) | null;
};

function isSelectionResolverObject(value: unknown): value is SelectionResolverObject {
  return !!value && typeof value === 'object';
}

export function scoreObjectForNormal(object: SelectionResolverObject | null | undefined) {
...
export function resolveSelectionObject(
  scene: SelectionResolverObject | null | undefined,
  selection: unknown,
...
function internalResolveSelectionObject(
  scene: SelectionResolverObject | null | undefined,
  selection: unknown,
  options: ResolvedSelectionResolverOptions,
) {
  if (selection == null) return null;
  if (isSelectionResolverObject(selection) && selection.isObject3D) return selection;
  ...
  if (typeof selection === 'object') {
    const selectionObject = selection as SelectionResolverObject;
    if (selectionObject.isObject3D) return selectionObject;
    ...
    const resolveCandidate = (candidate: unknown) => (
...
function resolveObjectFromString(
  scene: SelectionResolverObject | null | undefined,
  value: unknown,
  options: ResolvedSelectionResolverOptions,
) {
  ...
  if (options.allowNameContains) {
    let fallback = null;
    try {
      scene.traverse?.((obj: SelectionResolverObject) => {
...
function scoreObject(
  object: SelectionResolverObject | null | undefined,
  scoreFn: ((object: SelectionResolverObject) => number) | null,
) {
