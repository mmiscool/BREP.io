...
type SheetMetalFlangeRunOptions = {
  angleDeg?: any;
  baseType?: any;
  defaultInsideRadius?: any;
  defaultLegLength?: any;
  flangeLengthReference?: any;
  lockAngleToAbsolute?: boolean;
};
...
export function runSheetMetalFlange(instance: AnyRecord, options: SheetMetalFlangeRunOptions = {}) {
