...
function getWorldPosition(obj) {
  ...
  if (typeof obj.getWorldPosition === 'function') {
    try { return obj.getWorldPosition(out); } catch { /* ignore unavailable world transform */ }
  }
...
export class HoleFeature {
  ...
  async run(partHistory) {
    ...
    try { this.persistentData.holes = holeRecords; } catch { /* ignore persistent data write failure */ }
