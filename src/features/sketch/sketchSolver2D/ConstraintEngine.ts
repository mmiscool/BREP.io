...
export class ConstraintSolver {
    ...
    simplifyCoincidentConstraints() {
        ...
        const coincidentGroups: Record<string, Set<any>> = {};
        const pointToGroup: Record<string, any> = {};
        ...
        for (const [point, group] of Object.entries(coincidentGroups)) {
            const minId = Math.min(...Array.from(group).map(Number));
