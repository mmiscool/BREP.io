...
function normalizePrimitiveSegmentationSettings(params: any = {}) {
    void params;
    const settings = {
...
function toArrayBuffer(input: any): ArrayBuffer | null {
...
function buildImportSolidsFromGeometry(geometry, options: any = {}) {
    if (!geometry || !geometry.isBufferGeometry) return [];
...
function buildParameterSignature(params: any = {}) {
...
function buildInputSignature(raw, params: any = {}) {
