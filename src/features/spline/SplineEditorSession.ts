...
export class SplineEditorSession {
  ...
  constructor(viewer: any, featureID: any, options: any = {}) {
   ...
   * @returns {boolean}
   */
  activate(initialSpline: any = null, options: any = {}) {
    if (!this.viewer) {
      return false;
    }
   ...
   */
  setSplineData(spline: any, options: any = {}) {
  ...
  selectObject(id: any, options: any = {}) {
