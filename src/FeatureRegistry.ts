...
export class FeatureRegistry {
  features: FeatureClassLike[];
  aliases: Map<string, FeatureClassLike>;
  ...
  register(FeatureClass: FeatureClassLike | null | undefined) {
  ...
  get(featureName: unknown): FeatureClassLike {
  ...
  getSafe(featureName: unknown): FeatureClassLike | null {
  ...
  has(featureName: unknown): boolean {
    return !!this.getSafe(featureName);
  }

  // list all registered feature names
  listFeatureNames(shortNames = false): string[] {
