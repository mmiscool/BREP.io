...
export function simpleObjectToGraphNode(id: string, object: Record<string, number>) {
...
export function simpleObjectToDigraph(object: Record<string, Record<string, number>>) {
