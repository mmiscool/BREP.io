...
type StepOptions = {
  ...
  mergePlanarFaces?: boolean;
  planarNormalTolerance?: number;
  planarDistanceTolerance?: number;
  useTessellatedFaces?: boolean;
  exportFaces?: boolean;
  exportEdgesAsPolylines?: boolean;
};
 ...
 */
export function generateSTEP(solids, opts: StepOptions = {}) {
