...
function getNodePosixSync(): any {
  ...
  if (runtimeModule && typeof runtimeModule.createRequire === 'function') {
    const req = runtimeModule.createRequire((globalThis as any).__filename || globalThis.process.cwd());
