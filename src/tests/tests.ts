...
import {
    ...
    test_cam_async_generation_can_be_aborted,
    test_cam_async_swept_hulls_report_segment_progress,
    test_cam_async_adaptive_waterline_reports_sampling_progress_and_yields,
    test_cam_async_waterline_reports_fiber_progress_and_yields,
    test_cam_async_parallel_finish_reports_pass_progress_and_yields,
    test_cam_async_parallel_finish_yields_inside_dense_projection_pass,
    test_cam_plan_manager_async_progress_events_are_bounded,
    test_cam_worker_abort_terminates_active_worker,
    test_cam_worker_progress_yield_abort_wins_result_race,
    test_cam_worker_job_carries_global_stock_and_machine_once,
    test_cam_worker_skips_mesh_serialization_for_invalid_operations,
    test_cam_worker_serialization_failure_reports_feedback,
    test_cam_plan_manager_falls_back_when_worker_start_fails,
    test_cam_default_roughing_cuts_stock_outside_target_silhouette,
    test_cam_history_reports_empty_generation_feedback,
    test_cam_gcode_export_filename_uses_machine_file_extension,
    test_cam_history_progress_window_can_stop_generation,
    test_cam_history_clears_preview_after_global_setup_changes,
    ...
    test_cam_tool_shape_selection_persists_cutter_profile_metadata,
    test_cam_invalid_cutter_profile_reports_feedback_without_paths,
    test_cam_invalid_stepdown_reports_feedback_without_paths,
    test_cam_invalid_sampling_reports_feedback_without_paths,
    test_cam_invalid_machining_controls_report_feedback_without_paths,
    test_cam_invalid_machine_profile_reports_feedback_without_paths,
    test_cam_invalid_stock_profile_reports_feedback_without_paths,
    test_cam_serialized_mesh_rejects_non_finite_triangle_coordinates,
    test_cam_short_cutter_length_reports_cut_depth_warning,
    test_cam_cone_maximum_diameter_sets_effective_tool_diameter,
    test_cam_ball_cone_tool_generates_finite_surface_finish_and_swept_hulls,
    test_cam_cutter_profiles_evaluate_selected_shapes,
    test_cam_point_and_batch_drop_cutter_project_mesh_points,
    test_cam_path_drop_cutter_projects_uniform_and_adaptive_paths,
    test_cam_parallel_finish_feed_link_falls_back_when_direct_link_is_unsafe,
    test_cam_parallel_finish_cut_direction_preference_forbids_zigzag_reversal,
    test_cam_parallel_finish_low_hop_links_projected_passes_below_safe_height,
    test_cam_parallel_finish_projects_sloped_surface_and_alternates_zigzag,
    test_cam_parallel_finish_respects_raster_angle,
    test_cam_path_ordering_reorders_reverses_and_rotates_paths,
    test_cam_push_cutter_fiber_and_batch_intervals_are_deterministic,
    test_cam_weave_reconstructs_square_loop_and_reports_open_graphs,
    test_cam_weave_async_yields_during_dense_reconstruction,
    test_cam_line_filter_reduces_collinear_points_preserves_boundaries,
    test_cam_path_spans_sample_lines_arcs_and_reject_degenerate_input,
    test_cam_triangle_spatial_index_queries_projection_modes_and_matches_bruteforce,
    test_cam_low_hop_contour_links_passes_before_next_depth,
    test_cam_low_hop_contour_orders_split_level_paths_to_reduce_travel,
    test_cam_machine_profile_controls_posted_gcode_and_serialization,
    test_cam_operation_ui_exposes_face_targets_for_contour_finishing,
    test_cam_plan_manager_sanitizes_labeled_operation_options,
    test_cam_parallel_finish_selected_face_drives_region_and_preserves_protected_mesh,
    test_cam_primitive_cube_outside_contour_protects_target_material,
    test_cam_waterline_contour_generated_history_20260702094950_uses_full_depths,
    test_cam_waterline_contour_line_filter_keeps_generated_history_clear_of_solid,
    test_cam_waterline_contour_missing_selected_faces_does_not_fallback_to_whole_solid,
    test_cam_waterline_null_cut_depths_use_target_bounds,
    ...
    test_cam_part_history_model_change_invalidates_generated_operations,
    test_cam_plan_manager_invalidates_generated_operation_after_param_edit,
    test_cam_plan_manager_invalidates_stale_generated_payload_versions,
    test_cam_plan_manager_serializes_generated_operations,
    test_cam_plan_manager_uses_global_stock_profile_for_generated_bounds,
    test_cam_preview_renders_actual_toolpath_polyline,
    test_cam_preview_uses_preserved_filter_samples_for_slider_snap_points,
    test_cam_preview_renders_selected_cutter_profile_shape,
    test_cam_three_axis_raster_generates_gcode_from_cube_mesh,
    test_cam_workbench_registers_and_persists_part_history_state,
    test_cam_workbench_accordion_allows_side_panel_scrolling,
    test_cam_workbench_side_panel_visibility_is_cam_only,
    test_cam_workbench_side_panel_defaults_order_and_collapsed_state,
    test_cam_waterline_raster_protects_higher_cross_sections,
    test_cam_waterline_raster_respects_sloped_target_surfaces,
    test_cam_adaptive_waterline_contour_clears_circular_through_hole,
    test_cam_waterline_contour_strategies_clear_circular_through_hole,
    test_cam_adaptive_waterline_contour_generates_weave_loops_and_summary,
    test_cam_waterline_contour_offsets_cross_section_loops,
    test_cam_waterline_contour_orders_loops_to_reduce_travel,
    test_cam_waterline_contour_uses_push_weave_seed_loop,
...
import {
    ...
    test_history_test_snippet_toolbar_snapshot_compacts_cam_toolpaths,
...
export const testFunctions: any[] = [
    ...
    { test: test_history_test_snippet_toolbar_snapshot_compacts_cam_toolpaths, printArtifacts: false, exportFaces: false, exportSolids: false, resetHistory: true },
    ...
    { test: test_cam_async_adaptive_waterline_reports_sampling_progress_and_yields, printArtifacts: false, exportFaces: false, exportSolids: false, resetHistory: true },
    { test: test_cam_async_waterline_reports_fiber_progress_and_yields, printArtifacts: false, exportFaces: false, exportSolids: false, resetHistory: true },
    { test: test_cam_async_parallel_finish_reports_pass_progress_and_yields, printArtifacts: false, exportFaces: false, exportSolids: false, resetHistory: true },
    { test: test_cam_async_parallel_finish_yields_inside_dense_projection_pass, printArtifacts: false, exportFaces: false, exportSolids: false, resetHistory: true },
    { test: test_cam_plan_manager_async_progress_events_are_bounded, printArtifacts: false, exportFaces: false, exportSolids: false, resetHistory: true },
    { test: test_cam_async_generation_can_be_aborted, printArtifacts: false, exportFaces: false, exportSolids: false, resetHistory: true },
    { test: test_cam_worker_abort_terminates_active_worker, printArtifacts: false, exportFaces: false, exportSolids: false, resetHistory: true },
    { test: test_cam_worker_progress_yield_abort_wins_result_race, printArtifacts: false, exportFaces: false, exportSolids: false, resetHistory: true },
    { test: test_cam_worker_job_carries_global_stock_and_machine_once, printArtifacts: false, exportFaces: false, exportSolids: false, resetHistory: true },
    { test: test_cam_worker_skips_mesh_serialization_for_invalid_operations, printArtifacts: false, exportFaces: false, exportSolids: false, resetHistory: true },
    { test: test_cam_worker_serialization_failure_reports_feedback, printArtifacts: false, exportFaces: false, exportSolids: false, resetHistory: true },
    { test: test_cam_plan_manager_falls_back_when_worker_start_fails, printArtifacts: false, exportFaces: false, exportSolids: false, resetHistory: true },
    { test: test_cam_tool_shape_selection_persists_cutter_profile_metadata, printArtifacts: false, exportFaces: false, exportSolids: false, resetHistory: true },
    { test: test_cam_invalid_cutter_profile_reports_feedback_without_paths, printArtifacts: false, exportFaces: false, exportSolids: false, resetHistory: true },
    { test: test_cam_invalid_stepdown_reports_feedback_without_paths, printArtifacts: false, exportFaces: false, exportSolids: false, resetHistory: true },
    { test: test_cam_invalid_sampling_reports_feedback_without_paths, printArtifacts: false, exportFaces: false, exportSolids: false, resetHistory: true },
    { test: test_cam_invalid_machining_controls_report_feedback_without_paths, printArtifacts: false, exportFaces: false, exportSolids: false, resetHistory: true },
    { test: test_cam_invalid_machine_profile_reports_feedback_without_paths, printArtifacts: false, exportFaces: false, exportSolids: false, resetHistory: true },
    { test: test_cam_invalid_stock_profile_reports_feedback_without_paths, printArtifacts: false, exportFaces: false, exportSolids: false, resetHistory: true },
    { test: test_cam_serialized_mesh_rejects_non_finite_triangle_coordinates, printArtifacts: false, exportFaces: false, exportSolids: false, resetHistory: true },
    { test: test_cam_short_cutter_length_reports_cut_depth_warning, printArtifacts: false, exportFaces: false, exportSolids: false, resetHistory: true },
    { test: test_cam_cone_maximum_diameter_sets_effective_tool_diameter, printArtifacts: false, exportFaces: false, exportSolids: false, resetHistory: true },
    { test: test_cam_ball_cone_tool_generates_finite_surface_finish_and_swept_hulls, printArtifacts: false, exportFaces: false, exportSolids: false, resetHistory: true },
    ...
    { test: test_cam_cutter_profiles_evaluate_selected_shapes, printArtifacts: false, exportFaces: false, exportSolids: false, resetHistory: true },
    { test: test_cam_point_and_batch_drop_cutter_project_mesh_points, printArtifacts: false, exportFaces: false, exportSolids: false, resetHistory: true },
    { test: test_cam_path_drop_cutter_projects_uniform_and_adaptive_paths, printArtifacts: false, exportFaces: false, exportSolids: false, resetHistory: true },
    { test: test_cam_parallel_finish_feed_link_falls_back_when_direct_link_is_unsafe, printArtifacts: false, exportFaces: false, exportSolids: false, resetHistory: true },
    { test: test_cam_parallel_finish_cut_direction_preference_forbids_zigzag_reversal, printArtifacts: false, exportFaces: false, exportSolids: false, resetHistory: true },
    { test: test_cam_parallel_finish_low_hop_links_projected_passes_below_safe_height, printArtifacts: false, exportFaces: false, exportSolids: false, resetHistory: true },
    { test: test_cam_parallel_finish_projects_sloped_surface_and_alternates_zigzag, printArtifacts: false, exportFaces: false, exportSolids: false, resetHistory: true },
    { test: test_cam_parallel_finish_respects_raster_angle, printArtifacts: false, exportFaces: false, exportSolids: false, resetHistory: true },
    { test: test_cam_parallel_finish_selected_face_drives_region_and_preserves_protected_mesh, printArtifacts: false, exportFaces: false, exportSolids: false, resetHistory: true },
    { test: test_cam_path_ordering_reorders_reverses_and_rotates_paths, printArtifacts: false, exportFaces: false, exportSolids: false, resetHistory: true },
    { test: test_cam_push_cutter_fiber_and_batch_intervals_are_deterministic, printArtifacts: false, exportFaces: false, exportSolids: false, resetHistory: true },
    { test: test_cam_weave_reconstructs_square_loop_and_reports_open_graphs, printArtifacts: false, exportFaces: false, exportSolids: false, resetHistory: true },
    { test: test_cam_weave_async_yields_during_dense_reconstruction, printArtifacts: false, exportFaces: false, exportSolids: false, resetHistory: true },
    { test: test_cam_path_spans_sample_lines_arcs_and_reject_degenerate_input, printArtifacts: false, exportFaces: false, exportSolids: false, resetHistory: true },
    { test: test_cam_triangle_spatial_index_queries_projection_modes_and_matches_bruteforce, printArtifacts: false, exportFaces: false, exportSolids: false, resetHistory: true },
    { test: test_cam_line_filter_reduces_collinear_points_preserves_boundaries, printArtifacts: false, exportFaces: false, exportSolids: false, resetHistory: true },
    ...
    { test: test_cam_adaptive_waterline_contour_clears_circular_through_hole, printArtifacts: false, exportFaces: false, exportSolids: false, resetHistory: true },
    { test: test_cam_waterline_contour_strategies_clear_circular_through_hole, printArtifacts: false, exportFaces: false, exportSolids: false, resetHistory: true },
    { test: test_cam_adaptive_waterline_contour_generates_weave_loops_and_summary, printArtifacts: false, exportFaces: false, exportSolids: false, resetHistory: true },
    ...
    { test: test_cam_waterline_contour_orders_loops_to_reduce_travel, printArtifacts: false, exportFaces: false, exportSolids: false, resetHistory: true },
    { test: test_cam_waterline_contour_uses_push_weave_seed_loop, printArtifacts: false, exportFaces: false, exportSolids: false, resetHistory: true },
    { test: test_cam_operation_ui_exposes_face_targets_for_contour_finishing, printArtifacts: false, exportFaces: false, exportSolids: false, resetHistory: true },
    { test: test_cam_plan_manager_sanitizes_labeled_operation_options, printArtifacts: false, exportFaces: false, exportSolids: false, resetHistory: true },
    { test: test_cam_gcode_export_filename_uses_machine_file_extension, printArtifacts: false, exportFaces: false, exportSolids: false, resetHistory: true },
    { test: test_cam_waterline_contour_generated_history_20260702094950_uses_full_depths, printArtifacts: false, exportFaces: false, exportSolids: false, resetHistory: true },
    { test: test_cam_waterline_contour_line_filter_keeps_generated_history_clear_of_solid, printArtifacts: false, exportFaces: false, exportSolids: false, resetHistory: true },
    { test: test_cam_waterline_contour_missing_selected_faces_does_not_fallback_to_whole_solid, printArtifacts: false, exportFaces: false, exportSolids: false, resetHistory: true },
    { test: test_cam_waterline_null_cut_depths_use_target_bounds, printArtifacts: false, exportFaces: false, exportSolids: false, resetHistory: true },
    ...
    { test: test_cam_low_hop_contour_orders_split_level_paths_to_reduce_travel, printArtifacts: false, exportFaces: false, exportSolids: false, resetHistory: true },
    ...
    {
        test: test_cam_history_progress_window_can_stop_generation,
        printArtifacts: false,
        exportFaces: false,
        exportSolids: false,
        resetHistory: true,
    ...
    {
        test: test_cam_history_clears_preview_after_global_setup_changes,
        printArtifacts: false,
        exportFaces: false,
        exportSolids: false,
        resetHistory: true,
    ...
    { test: test_cam_plan_manager_uses_global_stock_profile_for_generated_bounds, printArtifacts: false, exportFaces: false, exportSolids: false, resetHistory: true },
    ...
    { test: test_cam_workbench_accordion_allows_side_panel_scrolling, printArtifacts: false, exportFaces: false, exportSolids: false, resetHistory: true },
    ...
    { test: test_cam_workbench_side_panel_defaults_order_and_collapsed_state, printArtifacts: false, exportFaces: false, exportSolids: false, resetHistory: true },
    ...
    { test: test_cam_part_history_model_change_invalidates_generated_operations, printArtifacts: false, exportFaces: false, exportSolids: false, resetHistory: true },
    ...
    { test: test_cam_plan_manager_invalidates_stale_generated_payload_versions, printArtifacts: false, exportFaces: false, exportSolids: false, resetHistory: true },
    ...
    { test: test_cam_preview_uses_preserved_filter_samples_for_slider_snap_points, printArtifacts: false, exportFaces: false, exportSolids: false, resetHistory: true },
    { test: test_cam_preview_renders_selected_cutter_profile_shape, printArtifacts: false, exportFaces: false, exportSolids: false, resetHistory: true },
