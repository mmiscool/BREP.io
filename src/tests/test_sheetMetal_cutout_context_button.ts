...
export async function test_sheetMetal_cutout_context_button() {
  ...
  const sketchResult: any = SheetMetalCutoutFeature.showContexButton([sketch]);
  ...
  const sketchFaceResult: any = SheetMetalCutoutFeature.showContexButton([sketchFace]);
  ...
  const solidResult: any = SheetMetalCutoutFeature.showContexButton([solid]);
