...
const initFontAuditPage = () => {
  ...
  const outputEl = document.getElementById('font-selection-output') as HTMLTextAreaElement | null;
  ...
  const filterInput = document.getElementById('font-filter') as HTMLInputElement | null;
  const sortInput = document.getElementById('font-sort') as HTMLSelectElement | null;
  const showSelectedOnlyInput = document.getElementById('show-selected-only') as HTMLInputElement | null;
