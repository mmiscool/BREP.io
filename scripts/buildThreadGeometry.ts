...
const defaultOutPath = resolve(repoRoot, 'src/generated/threadGeometryCatalog.ts');
  ...
  try {
    for (const standard of enabledStandards) {
      ...
      for (const preset of presets) {
        ...
        writeFileSync(resolve(tmpChunkDir, chunkName), `// Auto-generated by scripts/buildThreadGeometry.ts
...
`);
  ...
  const entries = chunks
    ...
    .join('\n');
  const source = `// Auto-generated by scripts/buildThreadGeometry.ts
