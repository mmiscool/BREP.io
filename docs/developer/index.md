...
Top-level hub for developer-facing documentation.
...
- [API Examples](./embedding/api-examples.md) - runnable examples and demo entry points
...
- [Kernel and Geometry Docs](./kernel/index.md) - kernel architecture, class APIs, topology, metadata, and geometry internals
...
- [PartHistory Reference](./architecture/part-history.md)
- [CadEmbed API](./embedding/cad-embed.md)
- [Sketcher2DEmbed API](./embedding/sketcher2d-embed.md)
