...
- [deduplicateFaceNames()](./deduplicateFaceNames.md)
...
- [findSelfIntersections(options)](./findSelfIntersections.md)
- [splitSelfIntersectingTriangles(options)](./splitSelfIntersectingTriangles.md)
- [cleanupSelfIntersections(options)](./cleanupSelfIntersections.md)
...
- [unionMany(solids, options)](./unionMany.md)
...
- [offsetShell(faces, distance, options)](./offsetShell.md)
