...
- [Kernel and Geometry Docs](./developer/kernel/index.md) - kernel architecture, class APIs, topology, metadata, and geometry internals
- [Embedding and Integration Docs](./developer/embedding/index.md) - `CadEmbed`, `Sketcher2DEmbed`, package usage, and demos
